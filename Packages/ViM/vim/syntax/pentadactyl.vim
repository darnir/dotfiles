...
syn keyword pentadactylOption activate act altwildmode awim autocomplete au
    ...
    \ nextpattern noscript-forbid nsf noscript-list nsl noscript-objects nso
    \ noscript-sites nss noscript-tempsites nst noscript-untrusted nsu pageinfo
    \ pa passkeys pk passunknown pu popups pps previouspattern runtimepath rtp
    \ sanitizeitems si sanitizeshutdown ss sanitizetimespan sts scroll scr
    \ scrollsteps scs scrolltime sct shell sh shellcmdflag shcf showmode smd
    \ showstatuslinks ssli showtabline stal spelllang spl strictfocus sf
    ...
    \ wordseparators wsp yankshort ys
...
let s:toggleOptions = ["banghist", "bh", "errorbells", "eb", "exrc", "ex",
    ...
    \ "jsdebugger", "jsd", "more", "online", "script", "timeout", "tmo",
